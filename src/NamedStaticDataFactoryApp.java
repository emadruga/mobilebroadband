...
public class NamedStaticDataFactoryApp extends JFrame { 
	...
	public NamedStaticDataFactoryApp() { 
		...
		add(new JLabel("Chapter 5 NamedStaticDataFactory Application")); 
	...
	public void onPreview() { 
		...
		try {
			...
			factory.setQuery("default", "ExampleFactory#getAllData");
	...
	public static void main(String args[]) {
		...
		NamedStaticDataFactoryApp app = new NamedStaticDataFactoryApp(); 
		app.pack(); 
		app.setVisible(true); 
	} 
}
