...
public class CdfTableModel extends DefaultTableModel implements IFaceTableModel {
	...
	private String[]	columnNames_Base	= { "operatorName", "parameter", "intervals", "frequencies", "rFrequencies", "crFrequencies", "intervalNames", "startDate", "endDate", "numSamples", "tput" };
